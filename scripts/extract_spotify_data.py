    ...
    try:
        for search_type in types:
            for market in markets:
                url = f"https://api.spotify.com/v1/search?q={time_range}&type={search_type}&market={market}&limit=50"
                headers = {
                ...
                if items_key in data and "items" in data[items_key]:
                    ...
                    if items:
                        ...
                        subdir = os.path.join(output_dir, f"{search_type}s", market)
